...
INSERT INTO users (user_id, password, username) 
VALUES (UUID_TO_BIN('b9089261-3e08-43ee-8f58-de5e9cb76cc3'), '$2a$12$Ei0ZtHu1K37/RTMgP97Uiefw5up03sy6dy1EDjlH4wEglrxSi/v3q', 'user');

INSERT INTO users_roles (user_model_user_id, roles_role_id)
VALUES (UUID_TO_BIN('b9089261-3e08-43ee-8f58-de5e9cb76cc3'), 2);